...
import { Trophy,Award,Users, MessageCircle,Truck,Phone,ArrowRight } from 'lucide-react'
      ...
      <section className="py-20 bg-gradient-to-br from-white via-red-50/30 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.h2
              className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-black text-gray-800 mb-4 sm:mb-6"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            <motion.p
              className="text-base sm:text-lg lg:text-xl xl:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed"
